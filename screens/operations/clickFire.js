...
class clickFire extends React.Component {
    ...
    take = (str) =>{
        let operationData = {}
        let armor = {
            נפיץ: this.state.נפיץ,
            עשן_ישן: this.state.עשן_ישן,
            עשן_חדש: this.state.עשן_חדש,
            תאורה: this.state.תאורה,
            מרעום137: this.state.מרעום137,
            מרעום739: this.state.מרעום739,
            מרעום557: this.state.מרעום557,
            M7: this.state.M7,
            M9: this.state.M9,
            תחל: this.state.תחל,
